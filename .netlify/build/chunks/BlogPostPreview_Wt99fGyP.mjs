...
const $$BlogPostPreview = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<article${addAttribute(`border p-4 transition-color duration-300 ease-out focus-within:outline hover:bg-sidebar rounded-lg shadow`, "class")}> <a${addAttribute(`/blog/${post.slug}/`, "href")} data-astro-prefetch class="block outline-none"> <header> <time${addAttribute(post.data.publishDate.toISOString(), "datetime")}> ${format(post.data.publishDate, "MMMM d, yyyy")} </time> <div class="flex flex-wrap items-center gap-2"> <span>By</span> ${post.data.authors.map((author) => {
...
}, "C:/Users/altie/Documents/BCUW/bcuw-v4-r2/src/pages/blog/_components/BlogPostPreview.astro", void 0);
