...
There are a total of 20 ranks in BlossomCraft, 19 of which are obtainable in some know way. There are 3 catagories we use to divide ranks:
...
Benifites of paid ranks:
You get way more abilities, and more of the things above.

Cons of paid ranks:
they cost IRL money.

A lot of the time, you do not need a paid rank, but they have insanely useful abilities like /fly.

Go to BlossomCraft's official [shop](https://shop.blossomcraft.org) to buy paid ranks.
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>6</TableCell>
      <TableCell>
        6 (estimated number, please contact @altie122 on discord if this is
        incorrect)
      </TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>✔️</TableCell>
      <TableCell>✔️</TableCell>
      <TableCell>[Custom Prefix](/tutorials/rgb-ranks/)</TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell></TableCell>
      <TableCell></TableCell>
      <TableCell>✔️ ([see list](#claim-flags))</TableCell>
      <TableCell>✔️ ([see list](#claim-flags))</TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      <TableCell>Cooldown Bypass (Eg. Instant /tpa, /home, etc)</TableCell>
      <TableCell></TableCell>
      <TableCell></TableCell>
      <TableCell></TableCell>
      <TableCell></TableCell>
...
Staff are the... well staff of BlossomCraft. They are the people who help keep BlossomCraft a safe and fun server!

there are 5 staff ranks:

- Helper
- Mod/Moderator
- SR Mod/Community Mentor
- Manager
- Admin