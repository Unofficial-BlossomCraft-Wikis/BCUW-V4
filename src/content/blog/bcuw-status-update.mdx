...
As of now, 7/26/2025, the BCUW project is on hold. This mostly affects the item and crate documentation. The V5 Website is still in active development and will continue to be developed.
...
V5 is a complete rewrite of the BCUW website aimed at making it easier to maintain and update. It prioritizes speed, ease of use, and accessibility. This website will be the first to allow users to create accounts[^1], make trade listings, and advertise their Player Warps. This website will be replacing the "community website" that was mentioned in the "[Welcome to BCUW v4](https://bcuw.xyz/blog/welcome-to-v4)" blog post.
...
As of now, a Discord server for BCUW has been created. It will be used to discuss the project and provide constant updates on the project. The server can be found [here](https://discord.gg/bcuw)[^3].

[^3]: This Discord server is NOT associated with BlossomCraft. This is an independent server. Roles may be given to staff of BlossomCraft who have verified they are using the same accounts, at my, Alton Rose's (altie122) discretion.